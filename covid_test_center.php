...
This is the infection script for the "Find Test Centers
Near You".

Functionality: It allows users to find test centers
...
<html lang="en">
    ...
    <body>
        ...
        <div class="jumbotron">
            <p style="font-size: 50px" class="lead">Find Test Centers Near You</p>
            <hr class="my-4">
